...
export async function buildFinalProfile(
    ...
    return {
        ...
        picture: "https://7871309f-1cc3-4e52-b3e7-0092c8fa743f.selstorage.ru/images/thumbnails/human/human_default.webp", 
...
export const CharacterFinalizer: React.FC<Props> = ({ selectedClass }) => {
  ...
  try {
    ...
    const tgId = String(session?.userId || session?.tgId || '').trim();
