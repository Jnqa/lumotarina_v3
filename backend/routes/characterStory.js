...
function generateBackgroundStory(answers) {
  ...
  switch (raceId) {
    ...
    case 'shadowblood': {
      ...
      intro = `Привет, ${g('мрачный тип', 'мрачная девушка')}! Твой путь начался в Ноктарине. Сейчас ты узнаешь, что случилось пару лет назад, но вся более ранняя история будет расказана тобой. 
...
// Игрок, твой выбор пал на расу Темнокровых, на следующем можешь выбрать любой понравившийся класс, но рекомендуемый класс лучше соответствует твоей предыстории`;
    ...
    case 'regalif': {
      ...
      intro = `Привет, ${greeting}! Твой путь начался в Ноктарине. Сейчас ты узнаешь, что случилось пару лет назад, но вся более ранняя история будет расказана тобой. `;
...
// Игрок, так как твой выбор пал на рассу Регалиф, то на следующем шаге рекомендую выбрать класс Регалиф. Чтобы сохранить осбобые способности класса, но выбор всегда за тобой.`;
    ...
    case 'animalic': {
      const g = (m, f) => genderId === 'male' ? m : f;
      intro = `Привет, ${g('пушистый или же ты ящер какой, а может весь в перьях?', 'пушистая или же ты ящерка какая, а может вся в перьях?')} Твой путь начался в Ноктарине. Сейчас ты узнаешь, что случилось пару лет назад, но вся более ранняя история будет расказана тобой. `;
      intro += `Поздним вечером ты решаешь отправиться в город. Рынок уже почти закрывался, но именно в это время там можно было решить дела без лишних глаз и вопросов. Ночь обещала быть спокойной, обычной, из тех, что не запоминаются.
